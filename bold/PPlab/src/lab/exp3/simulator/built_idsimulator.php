...
<body>
  <div class="top">
     ...
     <h1 style="font-size: 44px; color: white;">Analysis of Function by ID </h1>
     </ul>
     <div class="collapse navbar-collapse" id="collapse-1">
            <ul class="nav navbar-nav navbar-right" id="bs">
              <li><a href="built_type.php" style="font-size: 24px; margin-top: 1em; color: white;">Function by Type</a></li>
