    ...
    <body>
        <form action="" method="post">
            <div class="col-xl-2" style="background-color: #eee; font-size: 20px; text-align: center;padding: 5em;margin-top: 6em;">
                        ...
                        <h3 style="font-family: monospace;font-weight: lighter;"><b>5.How to Reverse the given list?<br>x=[2,5,8] </b>  </h3>
                        <div class="form-check" style="padding: 4px 28px;">
                       &nbsp; <input name="qus5" type="radio" class="form-check-input with-gap" value="reverse(x)">
                        <label class="form-check-label">reverse(x)</label>
                        </div>
                          <div class="form-check" style="padding: 4px 28px;">
                       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="qus5" type="radio" class="form-check-input with-gap" value="list(reverse[(x)])">
                        <label class="form-check-label">list(reverse[(x)])</label>
                        </div>
                          <div class="form-check" style="padding: 4px 28px;">
                       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="qus5" type="radio" class="form-check-input with-gap" value="revesrsed(x)">
                        <label class="form-check-label">revesrsed(x)</label>
                        </div>
                          <div class="form-check" style="padding: 4px 28px;">
                     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <input name="qus5" type="radio" class="form-check-input with-gap" value="list(reversed[(x)]">
                        <label class="form-check-label">list(reversed[(x)]</label>
                        </div>
