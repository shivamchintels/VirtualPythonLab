...
if(isset($_POST['submit']))
{
    ...
    mysqli_stmt_bind_param($query,'s',$qus7);
    ...
    <body>
        <form action="" method="post">
            <div class="col-xl-2" style="background-color: #eee; font-size: 20px; text-align: center;padding: 5em;margin-top: 6em;">
                        ...
                        <h3 style="font-family: monospace;font-weight: lighter;"><b>7.What will be the output of the following?<br>a=[3, 2, 1, 8, 6]<br>sorted(a)</b></h3>
                        <div class="form-check" style="padding: 4px 28px;">
                         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="qus7" type="radio" class="form-check-input with-gap" value="3 2 1 8 6">
                        <label class="form-check-label">3 2 1 8 6</label>
                        </div>
                          <div class="form-check" style="padding: 4px 28px;">
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="qus7" type="radio" class="form-check-input with-gap" value="31 2 3 6 8">
                        <label class="form-check-label">1 2 3 6 8</label>
                        </div>
                          <div class="form-check" style="padding: 4px 28px;">
                     <input name="qus7" type="radio" class="form-check-input with-gap" value="Error">
                        <label class="form-check-label">Error</label>
                        </div>
                          <div class="form-check" style="padding: 4px 28px;">
                         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="qus7" type="radio" class="form-check-input with-gap" value="8 6 3 2 1">
                        <label class="form-check-label">8 6 3 2 1</label>
                        </div>
