...
<html>
    ...
    <body>
       ...
       <div class="col-xl-2" style="background-color: #eee; font-size: 20px; text-align: center;padding: 5em;margin-top: 6em;">
                        ...
                        <h3 style="font-family: monospace;font-weight: lighter;"><b>4.What is the output of function showm below?<br>import math<br>abs(math.sqrt(16))</b></h3>
                  ...
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="qus4" type="radio" class="form-check-input with-gap" value="Error">
                        <label class="form-check-label">Error</label>
                          ...
                          <div class="form-check" style="padding: 4px 28px;">
                      &nbsp; <input name="qus4" type="radio" class="form-check-input with-gap" value="-4">
                    ...
                    &nbsp;<input name="qus4" type="radio" class="form-check-input with-gap" value="4">
                        <label class="form-check-label">4</label>
                          ...
                          <div class="form-check" style="padding: 4px 28px;">
                      &nbsp;&nbsp;&nbsp; <input name="qus4" type="radio" class="form-check-input with-gap" value="4.0">
                        <label class="form-check-label">4.0</label>
                        </div>
