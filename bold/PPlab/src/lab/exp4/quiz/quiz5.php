...
<html>
    ...
    <body>
       ...
       <div class="col-xl-2" style="background-color: #eee; font-size: 20px; text-align: center;padding: 5em;margin-top: 6em;">
                        ...
                        <h3 style="font-family: monospace;font-weight: lighter;"><b>5.What is the output of following?
	
	<br>x="abcd"<br>i="a"<br>while i in x:<br>print(i, end="")</b></h3>
                        <div class="form-check" style="padding: 4px 28px;">
                   <input name="qus4" type="radio" class="form-check-input with-gap" value="No Output">
                        <label class="form-check-label">No Output</label>
                        </div>
                          <div class="form-check" style="padding: 4px 28px;">
                       <input name="qus4" type="radio" class="form-check-input with-gap" value="i i i i i ">
                        <label class="form-check-label">i i i i i </label>
                        </div>
                           <div class="form-check" style="padding: 4px 28px;">
                    <input name="qus4" type="radio" class="form-check-input with-gap" value="a a a a a a ...">
                        <label class="form-check-label">a a a a a a ...</label>
                        </div>
                          <div class="form-check" style="padding: 4px 28px;">
                        <input name="qus4" type="radio" class="form-check-input with-gap" value="a b c d">
                        <label class="form-check-label">a b c d</label>
                        </div>
