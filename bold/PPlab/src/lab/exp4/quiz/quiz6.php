    ...
    <body>
        <form action="" method="post">
            <div class="col-xl-2" style="background-color: #eee; font-size: 20px; text-align: center;padding: 5em;margin-top: 6em;">
                        ...
                        <h3 style="font-family: monospace;font-weight: lighter;"><b>6.What is the output of the following?
 
  <br>s="virtual python lab"<br>for i in s.split():<br>print(i,end="")</b></h3>
                        <div class="form-check" style="padding: 4px 28px;">
                        <input name="qus6" type="radio" class="form-check-input with-gap" value="v,i,r,t,u,a,l, ,p,y,t,h,o,n, ,l,a,b,">
                        <label class="form-check-label">v,i,r,t,u,a,l, ,p,y,t,h,o,n, ,l,a,b,</label>
                        </div>
                          <div class="form-check" style="padding: 4px 28px;">
                     <input name="qus6" type="radio" class="form-check-input with-gap" value="v,i,r,t,u,a,l, ,p,y,t,h,o,n, ,l,a,b">
                        <label class="form-check-label">v,i,r,t,u,a,l, ,p,y,t,h,o,n, ,l,a,b</label>
                          ...
                          <div class="form-check" style="padding: 4px 28px;">
                       <input name="qus6" type="radio" class="form-check-input with-gap" value="virtual, python, lab">
                        <label class="form-check-label">virtual, python, lab</label>
                        </div>
                          <div class="form-check" style="padding: 4px 28px;">
