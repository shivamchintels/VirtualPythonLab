    ...
    <body>
        <form action="" method="post">
            <div class="col-xl-2" style="background-color: #eee; font-size: 20px; text-align: center;padding: 5em;margin-top: 6em;">
                        ...
                        <h3 style="font-family: monospace;font-weight: lighter;"><b>8.What is the output of the following?

  <br>for i in [a,b,c,d][::-1]:<br>print(i)</b></h3>
                        <div class="form-check" style="padding: 4px 28px;">
                       <input name="qus8" type="radio" class="form-check-input with-gap" value="a b c d">
                        <label class="form-check-label">a b c d</label>
                        </div>
                          <div class="form-check" style="padding: 4px 28px;">
                       <input name="qus8" type="radio" class="form-check-input with-gap" value="d c b a">
                        <label class="form-check-label">d c b a</label>
                        </div>
                          <div class="form-check" style="padding: 4px 28px;">
                        <input name="qus8" type="radio" class="form-check-input with-gap" value="no output">
                        <label class="form-check-label">no output</label>
                        </div>
                          <div class="form-check" style="padding: 4px 28px;">
						<input name="qus8" type="radio" class="form-check-input with-gap" value="Error">
