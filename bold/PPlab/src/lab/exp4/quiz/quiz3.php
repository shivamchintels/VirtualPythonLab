...
<html>
    ...
    <body>
       ...
       <div class="col-xl-2" style="background-color: #eee; font-size: 20px; text-align: center;padding: 5em;margin-top: 6em;">
                        ...
                        <h3 style="font-family: monospace;font-weight: lighter;"><b>3.What is the output of the Following?

	<br>x='SALES'<br>for i in range(x):<br>	print(i)</b></h3>
                        <div class="form-check" style="padding: 4px 28px;">
                      <input name="qus3" type="radio" class="form-check-input with-gap" value="S A L E S">
                        <label class="form-check-label">S A L E S</label>
                        </div>
                           <div class="form-check" style="padding: 4px 28px;">
                        <input name="qus3" type="radio" class="form-check-input with-gap" value="0 1 2 3">
                        ...
                        <label class="form-check-label">Error</label>
                           ...
                           <div class="form-check" style="padding: 4px 28px;">
                     <input name="qus3" type="radio" class="form-check-input with-gap" value="None">
