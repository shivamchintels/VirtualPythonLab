    ...
    <body>
        <form action="" method="post">
            <div class="col-xl-2" style="background-color: #eee; font-size: 20px; text-align: center;padding: 5em;margin-top: 6em;">
                        ...
                        <h3 style="font-family: monospace;font-weight: lighter;"><b>7.What will be the output of the following?
  <br>
  x=2 <br>for i in range(x):<br>x+=1<br>print(x)</b></h3>
                        <div class="form-check" style="padding: 4px 28px;">
                       <input name="qus7" type="radio" class="form-check-input with-gap" value="0 1 2 3 4">
                        <label class="form-check-label">0 1 2 3 4</label>
                        </div>
                          <div class="form-check" style="padding: 4px 28px;">
                     <input name="qus7" type="radio" class="form-check-input with-gap" value="0 1">
                        <label class="form-check-label">0 1</label>
                        </div>
                          <div class="form-check" style="padding: 4px 28px;">
                        <input name="qus7" type="radio" class="form-check-input with-gap" value="3 4">
                        <label class="form-check-label">3 4</label>
                        </div>
                          <div class="form-check" style="padding: 4px 28px;">
                        <input name="qus7" type="radio" class="form-check-input with-gap" value="0 1 2 3">
