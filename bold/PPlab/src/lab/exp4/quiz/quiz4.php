    ...
    <body>
        <form action="" method="post">
            <div class="col-xl-2" style="background-color: #eee; font-size: 20px; text-align: center;padding: 5em;margin-top: 6em;">
                        ...
                        <h3 style="font-family: monospace;font-weight: lighter;"><b>4.What is the output of the following?
 
  <br>A='abcd'<br>for i in range(len(A))<br>A='a'<br>print(A)</b>
  </h3>
                        <div class="form-check" style="padding: 4px 28px;">
                        <input name="qus5" type="radio" class="form-check-input with-gap" value="a">
                        <label class="form-check-label">a</label>
                        </div>
                          <div class="form-check" style="padding: 4px 28px;">
                       &nbsp; <input name="qus5" type="radio" class="form-check-input with-gap" value="abcd">
                        <label class="form-check-label">abcd</label>
                        </div>
                          <div class="form-check" style="padding: 4px 28px;">
                        <input name="qus5" type="radio" class="form-check-input with-gap" value="a a a a">
                        <label class="form-check-label">a a a a</label>
                        </div>
                          <div class="form-check" style="padding: 4px 28px;">
                       <input name="qus5" type="radio" class="form-check-input with-gap" value="None of the above">
