    ...
    <body>
        <form action="" method="post">
            <div class="col-xl-2" style="background-color: #eee; font-size: 20px; text-align: center;padding: 5em;margin-top: 6em;">
                        ...
                        <h3 style="font-family: monospace;font-weight: lighter;"><b>1.What is the output of the following?<br>t=['abc','def']<br> for i in t:<br>&nbsp&nbsp&nbsp&nbsp i.upper()<br>print(t) </b>
						...
						<input name="qus1" type="radio" class="form-check-input with-gap" value="['abc','def']" >
						<label class="form-check-label" for="radio106">['abc','def']</label>
					  </div>
					  <div class="form-check" style="padding: 4px 28px;">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="qus1" type="radio" class="form-check-input with-gap" value="['ABC','DEF']">
						<label class="form-check-label" for="radio107">['ABC','DEF']</label>
					  </div>

						 <div class="form-check" style="padding: 4px 28px;">
						&nbsp;&nbsp;&nbsp;&nbsp;<input name="qus1" type="radio" class="form-check-input with-gap" value="[None,None]" >
						<label class="form-check-label" for="radio108">[None,None]</label>
					  </div>
					  <div class="form-check" style="padding: 4px 28px;">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="qus1" type="radio" class="form-check-input with-gap" value="None of the mentioned">
						<label class="form-check-label" for="radio109">None of the mentioned</label>
						</div>
