...
<html>
    ...
    <body>
       ...
       <div class="col-xl-2" style="background-color: #eee; font-size: 20px; text-align: center;padding: 5em;margin-top: 6em;">
                        ...
                        <h3 style="font-family: monospace;font-weight: lighter;"><b>2.What is the output of the following?
<br>
<br>i=1<br>while True:<br>	if(i%3==0):<br>	break<br>	print(i)<br>	i+=1</b></h3>
						   <div class="form-check" style="padding: 4px 28px;">
							<input name="qus2" type="radio" class="form-check-input with-gap" value="1 2" >
							<label class="form-check-label" for="radio106">1 2</label>
						  </div>
						   <div class="form-check" style="padding: 4px 28px;">
							<input name="qus2" type="radio" class="form-check-input with-gap" value="1 2 3" >
							<label class="form-check-label" for="radio107">1 2 3</label>
						</div>
						 <div class="form-check" style="padding: 4px 28px;">
							<input name="qus2" type="radio" class="form-check-input with-gap" value="Error" >
							<label class="form-check-label" for="radio108">Error</label>
						  </div>
						   <div class="form-check" style="padding: 4px 28px;">
							<input name="qus2" type="radio" class="form-check-input with-gap" value="None Of the Above" >
							<label class="form-check-label" for="radio109">None Of the Above</label>
							</div>
