...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="arith.css">
...
45 / 9 will give 5.0 where as 45 // 9 will give 5<br><br>

<b><h2><span id="#3">Objective</span></h2></b><hr>

1.	To understand the basics of arithmetic operations used in Python programming.<br>

2.	To learn using these operations while programming.<br><br>

<b><h2><span id="#4">Manual</span></h2></b><hr>

In this lab you will learn to perform arithmetic operations with the help of a user friendly GUI.<br><br>
...
7.	The local variables will be shown in the Output Panel with their values.</b><br><br><br>
