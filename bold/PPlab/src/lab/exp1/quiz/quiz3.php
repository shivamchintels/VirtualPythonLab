...
<html>
    ...
    <body>
       ...
       <div class="col-xl-2" style="background-color: #eee; font-size: 20px; text-align: center;padding: 5em;margin-top: 6em;">
                        ...
                        <h3 style="font-family: monospace;font-weight: lighter;">3.AND, OR, NOT are example of:</h3>
                        <div class="form-check" style="padding: 4px 28px;">
                      <input name="qus3" type="radio" class="form-check-input with-gap" value="Boolean Operator">
                        <label class="form-check-label"> Boolean Operator</label>
                        </div>
                           <div class="form-check" style="padding: 4px 28px;">
                        <input name="qus3" type="radio" class="form-check-input with-gap" value="Logical Operator">
                        <label class="form-check-label">Logical Operator</label>
                        </div>
                          <div class="form-check" style="padding: 4px 28px;">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="qus3" type="radio" class="form-check-input with-gap" value="Comparison Operator">
                        <label class="form-check-label">Comparison Operator</label>
                        </div>
                           <div class="form-check" style="padding: 4px 28px;">
                     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="qus3" type="radio" class="form-check-input with-gap" value="Assignment Operator">
