    ...
    <body>
        <form action="" method="post">
            <div class="col-xl-2" style="background-color: #eee; font-size: 20px; text-align: center;padding: 5em;margin-top: 6em;">
                        ...
                        <h3 style="font-family: monospace;font-weight: lighter;">8.What will be the output?<br>a = -31<br>b = 30<br>print(a+b)</h3>
                        <div class="form-check" style="padding: 4px 28px;">
                       &nbsp; <input name="qus8" type="radio" class="form-check-input with-gap" value="-1">
                        <label class="form-check-label"> -1</label>
                        </div>
                          <div class="form-check" style="padding: 4px 28px;">
                       &nbsp; <input name="qus8" type="radio" class="form-check-input with-gap" value="61">
                        <label class="form-check-label">61</label>
                        </div>
                          <div class="form-check" style="padding: 4px 28px;">
