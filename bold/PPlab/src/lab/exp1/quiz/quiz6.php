    ...
    <body>
        <form action="" method="post">
            <div class="col-xl-2" style="background-color: #eee; font-size: 20px; text-align: center;padding: 5em;margin-top: 6em;">
                        ...
                        <h3 style="font-family: monospace;font-weight: lighter;">6.Which one of the following have the same precedence?</h3>
                        <div class="form-check" style="padding: 4px 28px;">
                        <input name="qus6" type="radio" class="form-check-input with-gap" value="* and /">
                     ...
                     <input name="qus6" type="radio" class="form-check-input with-gap" value="+ and -">
                        <label class="form-check-label">+ and -</label>
                          ...
                          <div class="form-check" style="padding: 4px 28px;">
                       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input name="qus6" type="radio" class="form-check-input with-gap" value="None of these">
                        <label class="form-check-label">None of these</label>
                        </div>
                          <div class="form-check" style="padding: 4px 28px;">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="qus6" type="radio" class="form-check-input with-gap" value="Both A and B">
