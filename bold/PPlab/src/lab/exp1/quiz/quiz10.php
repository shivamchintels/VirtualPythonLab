    ...
    <body>
        <form action="" method="post">
            <div class="col-xl-2" style="background-color: #eee; font-size: 20px; text-align: center;padding: 5em;margin-top: 6em;">
                        ...
                        <h3 style="font-family: monospace;font-weight: lighter;">10.Which one of these is floor division?</h3>
                        <div class="form-check" style="padding: 4px 28px;">
                       <input name="qus9" type="radio" class="form-check-input with-gap" value="**">
