    ...
    <body>
        <form action="" method="post">
            <div class="col-xl-2" style="background-color: #eee; font-size: 20px; text-align: center;padding: 5em;margin-top: 6em;">
                        ...
                        <h3 style="font-family: monospace;font-weight: lighter;">9.What will be the output?<br>x = 5.5<br>y = 5.5<br>print(x+y)</h3>
                        <div class="form-check" style="padding: 4px 28px;">
                       &nbsp; <input name="qus9" type="radio" class="form-check-input with-gap" value="11">
                        <label class="form-check-label"> 11</label>
                        </div>
                          <div class="form-check" style="padding: 4px 28px;">
                       &nbsp; <input name="qus9" type="radio" class="form-check-input with-gap" value="10">
                        <label class="form-check-label">10</label>
                        </div>
                          <div class="form-check" style="padding: 4px 28px;">
                        <input name="qus9" type="radio" class="form-check-input with-gap" value="0">
                        <label class="form-check-label">0</label>
                        </div>
                          <div class="form-check" style="padding: 4px 28px;">
                 &nbsp; &nbsp;   <input name="qus9" type="radio" class="form-check-input with-gap" value="11.0">
                        <label class="form-check-label">11.0</label>
                        </div>
