    ...
    <body>
        <form action="" method="post">
            <div class="col-xl-2" style="background-color: #eee; font-size: 20px; text-align: center;padding: 5em;margin-top: 6em;">
                        ...
                        <h3 style="font-family: monospace;font-weight: lighter;">5.What is answer of this expression, 10 % 3 is?</h3>
                        <div class="form-check" style="padding: 4px 28px;">
                        <input name="qus5" type="radio" class="form-check-input with-gap" value="3">
                        <label class="form-check-label"> 3</label>
                        </div>
                          <div class="form-check" style="padding: 4px 28px;">
                       &nbsp; <input name="qus5" type="radio" class="form-check-input with-gap" value="10">
                        <label class="form-check-label">10</label>
                        </div>
                          <div class="form-check" style="padding: 4px 28px;">
                        <input name="qus5" type="radio" class="form-check-input with-gap" value="1">
                        <label class="form-check-label">1</label>
                        </div>
                          <div class="form-check" style="padding: 4px 28px;">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="qus5" type="radio" class="form-check-input with-gap" value="3.33">
                        <label class="form-check-label">3.33</label>
                        </div>
