...
<html>
    ...
    <body>
       ...
       <div class="col-xl-2" style="background-color: #eee; font-size: 20px; text-align: center;padding: 5em;margin-top: 6em;">
                        ...
                        <h3 style="font-family: monospace;font-weight: lighter;"><b>4.What is the output of print([4,2,7]+[3,2,6])?</b></h3>
                        <div class="form-check" style="padding: 4px 28px;">
                   <input name="qus4" type="radio" class="form-check-input with-gap" value="[4, 2, 7, 3, 2, 6]">
                        <label class="form-check-label">[4, 2, 7, 3, 2, 6]</label>
                        </div>
                          <div class="form-check" style="padding: 4px 28px;">
                       <input name="qus4" type="radio" class="form-check-input with-gap" value="[4, 3, 2, 2, 7, 6]">
                        <label class="form-check-label">[4, 3, 2, 2, 7, 6]</label>
                        </div>
                           <div class="form-check" style="padding: 4px 28px;">
                    <input name="qus4" type="radio" class="form-check-input with-gap" value="[7, 4, 13]">
                        <label class="form-check-label">[7, 4, 13]</label>
                        </div>
                          <div class="form-check" style="padding: 4px 28px;">
                        <input name="qus4" type="radio" class="form-check-input with-gap" value="Error">
