...
<html>
    ...
    <body>
        <form action="" method="post">
            <div class="col-xl-2" style="background-color: #eee; font-size: 20px; text-align: center;padding: 5em;margin-top: 6em;">
                        ...
                        <h3 style="font-family: monospace;font-weight: lighter;"><b>9.What will be the output?
    ...
    t[1:-1] <br>
                       ...
                       <input name="qus10" type="radio" class="form-check-input with-gap" value="(1, 2)">
                        <label class="form-check-label">(1, 2)</label>
                        </div>
                          <div class="form-check" style="padding: 4px 28px;">
                       <input name="qus10" type="radio" class="form-check-input with-gap" value="(1, 2, 4)">
                        <label class="form-check-label">(1, 2, 4)</label>
                        </div>
                          <div class="form-check" style="padding: 4px 28px;">
                        <input name="qus10" type="radio" class="form-check-input with-gap" value="(2, 4)">
                        <label class="form-check-label">(2, 4)</label>
                        </div>
                          <div class="form-check" style="padding: 4px 28px;">
						<input name="qus10" type="radio" class="form-check-input with-gap" value="(2, 4, 5)">
                        <label class="form-check-label">(2, 4, 5)</label>
                        </div>
