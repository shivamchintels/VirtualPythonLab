    ...
    <body>
        <form action="" method="post">
            <div class="col-xl-2" style="background-color: #eee; font-size: 20px; text-align: center;padding: 5em;margin-top: 6em;">
                        ...
                        <h3 style="font-family: monospace;font-weight: lighter;"><b>1.Suppose list1 is [31,53,25,12,36]<br> What is min(list1)?</b></h3>

       
							<div class="form-check" style="padding: 4px 28px;">
						<input name="qus1" type="radio" class="form-check-input with-gap" value="36" >
						<label class="form-check-label" for="radio106">36</label>
					  </div>
					  <div class="form-check" style="padding: 4px 28px;">
						<input name="qus1" type="radio" class="form-check-input with-gap" value="53">
						<label class="form-check-label" for="radio107">53</label>
					  </div>
					  ...
					  <div class="form-check" style="padding: 4px 28px;">
						...
						<label class="form-check-label" for="radio109">12</label>
						</div>
