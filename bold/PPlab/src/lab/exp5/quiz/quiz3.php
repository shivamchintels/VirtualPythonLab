...
<html>
    ...
    <body>
       ...
       <div class="col-xl-2" style="background-color: #eee; font-size: 20px; text-align: center;padding: 5em;margin-top: 6em;">
                        ...
                        <h3 style="font-family: monospace;font-weight: lighter;"><b>3.What is the output of print(tuple[0]) ?<br>
	tuple = ('abcd',786,2.23,'john',70.2) </b></h3>
                        <div class="form-check" style="padding: 4px 28px;">
                      <input name="qus3" type="radio" class="form-check-input with-gap" value="('abcd',786,2.23,'john',70.2)">
                        <label class="form-check-label">('abcd',786,2.23,'john',70.2)</label>
                        </div>
                           <div class="form-check" style="padding: 4px 28px;">
                        <input name="qus3" type="radio" class="form-check-input with-gap" value="abcd">
                        <label class="form-check-label">abcd</label>
                        </div>
                          <div class="form-check" style="padding: 4px 28px;">
                        <input name="qus3" type="radio" class="form-check-input with-gap" value="Error">
                        <label class="form-check-label">Error</label>
                        </div>
                           <div class="form-check" style="padding: 4px 28px;">
                     <input name="qus3" type="radio" class="form-check-input with-gap" value="None of the above">
