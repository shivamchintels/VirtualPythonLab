    ...
    <body>
        <form action="" method="post">
            <div class="col-xl-2" style="background-color: #eee; font-size: 20px; text-align: center;padding: 5em;margin-top: 6em;">
                        ...
                        <h3 style="font-family: monospace;font-weight: lighter;"><b>7.What will be the output? <br>
  d1={'rose':40,'lilly':45} <br>
	print(d1["rose"]) </b></h3>
                        <div class="form-check" style="padding: 4px 28px;">
                       <input name="qus7" type="radio" class="form-check-input with-gap" value="40">
                        <label class="form-check-label">40</label>
                        </div>
                          <div class="form-check" style="padding: 4px 28px;">
                     <input name="qus7" type="radio" class="form-check-input with-gap" value="45">
                        ...
                        <label class="form-check-label">Error</label>
                          ...
                          <div class="form-check" style="padding: 4px 28px;">
                        <input name="qus7" type="radio" class="form-check-input with-gap" value="rose">
