    ...
    <body>
        <form action="" method="post">
            <div class="col-xl-2" style="background-color: #eee; font-size: 20px; text-align: center;padding: 5em;margin-top: 6em;">
                        ...
                        <h3 style="font-family: monospace;font-weight: lighter;"><b>6.Which of the following statement create a dictionary?</b></h3>
                        <div class="form-check" style="padding: 4px 28px;">
                        <input name="qus6" type="radio" class="form-check-input with-gap" value="dict={} ">
                        <label class="form-check-label">dict={} </label>
                        </div>
                          <div class="form-check" style="padding: 4px 28px;">
                     <input name="qus6" type="radio" class="form-check-input with-gap" value="dict={'jack':4,'peter':5',john':6}">
                        <label class="form-check-label">dict={'jack':4,'peter':5',john':6}</label>
                        </div>
                          <div class="form-check" style="padding: 4px 28px;">
                       <input name="qus6" type="radio" class="form-check-input with-gap" value="dict={4:'jack',5:'peter',6:'john'}">
                        <label class="form-check-label">dict={4:'jack',5:'peter',6:'john'}</label>
                        </div>
                          <div class="form-check" style="padding: 4px 28px;">
                        <input name="qus6" type="radio" class="form-check-input with-gap" value="All of the above">
