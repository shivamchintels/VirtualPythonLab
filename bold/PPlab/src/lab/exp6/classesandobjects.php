...
<link rel="stylesheet" type="text/css" href="classesandobjects.css">
</head>
...
<div class="top">
     ...
     <b><h1 style="color: white;"><b style="color:#CAEBF2;font-family: monospace;font-size: 48px;">Python</b> programming language</h1></b>
     </ul>
        
        <div class="collapse navbar-collapse" id="collapse-1">
            <ul class="nav navbar-nav navbar-right" id="bs">
              <li><a href="#" class="link1" style="color: #fff;">Simulator</a></li>
              <li><a href="simulator\.php" class="link2" style="color: #fff;">Quiz</a></li>
              <li class="dropdown">
...
<div class="as">
<h1><b>Classes and Objects</h1><br>
